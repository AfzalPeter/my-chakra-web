                ...
                <List spacing={4}>
                  <ListItem padding={'2'}>
                    ...
                    <Text fontSize={'sm'}>
                      ...
                      <p>Top-Rated Crypto Token Sales: https://cryptototem.com/ico-list/</p>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}> Project Part 1 </Text>
                    <p>How to Launch a IEO on Binance Launchpad</p>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}> Project Part 2:  </Text>
                    <p>How to Launch a IDO on Polkastarter</p>
                    <Text fontSize={'sm'}>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}>Project Part 3:</Text>
                    <p> Create a Pako Token</p>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}> Project Part 4: </Text>
                    <p>Develop Crowd Sale Contract </p>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}>Project Part 5:</Text>
                    <p>Trying it with MetaMask </p>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}> Project Part 6:</Text>
                    <p>Trying it with Multisignature Wallets </p>
                    <Text fontSize={'sm'}>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}>Project Part 7: </Text>
                    <p>Sending Tokens using Ethers.js  </p>
                    <Text fontSize={'sm'}>
                  ...
                  <ListItem>
                    <Text as={'span'} fontWeight={'bold'}>Project Part 8 Advance:</Text>
                    <p> Create, Deploy, Mint, and Sell an NFT </p>
                    <Text fontSize={'sm'}>
